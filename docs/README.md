...
| Google Play の掲載・申告・署名・公開までの分担 | [公開準備計画](play-release-plan.md) |
| ストア掲載文とプライバシーポリシーの準備稿 | [掲載文案](play-store-listing.md)・[ポリシー](site/privacy-policy.html) |
...
- [監査資料](audit/README.md) はライセンス・出典調査の入力と結果を保存します。
